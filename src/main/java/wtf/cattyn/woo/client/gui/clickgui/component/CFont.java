...
public class CFont {
    ...
    public void drawChar(CharData[] chars, char c2, float x, float y) throws ArrayIndexOutOfBoundsException {
        try {
            this.drawQuad(x, y, chars[c2].width, chars[c2].height, chars[c2].storedX, chars[c2].storedY, chars[c2].width, chars[c2].height);
            return;
        }
        catch (Exception e) {
            e.printStackTrace();
