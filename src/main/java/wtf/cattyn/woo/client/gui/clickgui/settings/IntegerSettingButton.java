...
public class IntegerSettingButton
extends SettingButton {
    private final Setting.i setting;
    private boolean dragging;
    private int sliderWidth;

    public IntegerSettingButton(CategoryButton parentCategory, Module module, int x, int y, int w, int h, Setting.i setting) {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        Woo.fontManager.drawCenteredString(String.valueOf(this.setting.getValue()), (float)(this.x + this.w / 2) / 0.9f * 1.0f, (float)(this.y + 16) / 0.9f * 1.0f, -1, false);
    ...
    private void updateSlider(int mouseX) {
        ...
        this.sliderWidth = (int)((double)(this.w - 10) * ((double)this.setting.getValue() - minimum) / (maximum - minimum));
        ...
        this.setting.setValue((int)(diff / (double)(this.w - 10) * (maximum - minimum) + minimum));
    }
